...
const NAV = [
  ...
  { label: "Sale", href: "sale.html", standout: true },
];
...
function buildNavHTML(currentPage) {
  return `<ul>
    ${NAV.map(item => {
      ...
      const extraClass = item.standout ? " nav-link-sale" : "";
      return `<li${hasChildren ? ' class="has-children"' : ''}>
        <a class="nav-link${extraClass}${isCurrent ? ' is-current' : ''}" href="${item.href}">
          ${item.label}
...
function headerHTML(currentPage) {
  ...
  <div class="header-inner">
    <a href="index.html" class="brand" aria-label="Orcas Wildflower home">
      ...
      <span class="brand-word">Orcas Wildflower<small>Orcas Island, Washington</small></span>
    </a>
    ...
    <div class="footer-grid" style="margin-top:36px;">
      <div class="footer-col footer-brand">
        ...
        <div class="social-icons" style="margin-top:16px;">
          <a class="ig" href="https://www.instagram.com/orcas_wildflower/" target="_blank" rel="noopener" aria-label="Instagram">
          ...
          <a class="fb" href="https://www.facebook.com/profile.php?id=61559796787558" target="_blank" rel="noopener" aria-label="Facebook">
          ...
          <a class="mail" href="mailto:orcaswildflower@outlook.com" aria-label="Email">
